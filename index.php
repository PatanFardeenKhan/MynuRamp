...
<head>
  ...
  <title>Ramp - Spend Management Platform</title>
  ...
  <nav id="navbar"
    ...
    <div class="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
      ...
      <div id="navLinks" class="hidden md:flex gap-6 text-sm">
        ...
        <button class="signin-btn border px-4 py-2 rounded-md text-sm md:hidden">Sign in</button>
        <button class="demo-btn px-4 py-2 rounded-md text-sm font-semibold md:hidden">See a demo</button>
      </div>

      <!-- Desktop Buttons -->
      <div class="hidden md:flex gap-4">
        <button class="signin-btn border px-4 py-2 rounded-md text-sm">Sign in</button>
        <button class="demo-btn px-4 py-2 rounded-md text-sm font-semibold">See a demo</button>
      </div>
    </div>
  </nav>
    ...
    <footer class="footer">
      ...
      <div class="footer-wrapper">
        <div class="footer-container">
          ...
          <!-- Column 6 -->
          <div class="footer-section">
            <h3>Free tools and resources</h3>
            <ul>
              <li><a href="#">Perks and rewards</a></li>
              <li><a href="#">Find an accountant</a></li>
              <li><a href="#">Expense policy template</a></li>
              <li><a href="#">Accounting documents library</a></li>
              <li><a href="#">Savings calculator</a></li>
              <li><a href="#">Mission statement generator</a></li>
              <li><a href="#">Charge finder</a></li>
              <li><a href="#">Unit economics model</a></li>
              <li><a href="#">Per diem calculator</a></li>
            </ul>
          </div>
        </div>
        <div class="footer-bottom">
          © 2025 Ramp Business Corporation. All rights reserved.
        </div>
      </div>
    </footer>
  <?php
